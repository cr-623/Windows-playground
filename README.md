...
## WARNING:
* HWNDs are not persistent. If a window closes or a process terminates, the HWND will be invalid.
* After you hide a window, you usually can't get the HWND back unless you've saved it
